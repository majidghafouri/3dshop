...
export const en: typeof fa = {
  ...
  auth: {
    ...
    registerSubtitle: "Enter your email to get a verification code",
    ...
    errorUserExists: "This email is already registered. Sign in with your password.",
    errorNoPassword: "No password has been set for this email. Please register first.",
