...
export const en: typeof fa = {
  ...
  auth: {
    ...
    registerSubtitle: "Enter your mobile number to get a verification code",
    forgotTitle: "Forgot password",
    forgotSubtitle: "Enter your mobile number to reset your password",
    ...
    errorUserExists: "This phone number is already registered. Sign in with your password.",
    errorNoPassword: "No password has been set for this number. Please register first.",
  ...
  admin: {
    ...
    otpChannel: {
      title: "OTP SMS channel",
      subtitle: "Choose the verification SMS line: service line (template) or advertise line (free send).",
      advertise: "Advertise line (free send)",
      advertiseDesc: "Uses the SMS send method (sms/send). Default.",
      service: "Service line (template)",
      serviceDesc: "Uses the Kavenegar verification template (verify/lookup).",
      sender: "Advertise line number",
      senderPlaceholder: "e.g. 3000XXXXXX or 10004346",
      senderHint: "An advertise-line number approved in your Kavenegar account for the free-send method (sms/send) — this is different from the verify/service line. Falls back to the account default when empty. A wrong line returns error 412 (invalid sender).",
